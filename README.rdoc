...
* Recovery after a memcached server dies isn't very good. If this module cannot connect to memcached, it will fail open. Errors will appear in the apache error log.
